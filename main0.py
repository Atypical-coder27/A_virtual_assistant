...
speak('your personal Assistant is about to load in')
speak('3')
speak('2')
speak('1')
speak('loading the user interface')
speak('please press the start button to activate your assistant')
...
def Intro():
     ...
     time()
     speak("Present at your Service, Ask me anything")
...
def news():
     main_url = "https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=''"
     ...
     def TaskExecution(self):
          ...
          while True:
               ...
               if 'wikipedia' in self.query:
                    ...
                    speak('Hello hope you had an awesome day')
               ...
               elif 'who do you work for' in self.query:
                    ...
                    speak('which place do you want me to find')
                    ...
                    webbrowser.open('your_college@website')
                    ...
                    read = int(self.coms().lower())
                    speak(f'opening page number{read}')
                    ...
                    def get_email_info():
                         speak('whos receiving')
                         namee = self.coms().lower()
                         receiver = email_list[namee]
                         print(receiver)
                         speak('what shall be the subject of your email')
                         subject = self.coms().lower()
                         speak('what do you want to write in body')
          ...
          if __name__=='__main__':
               while True:
                    ...
                    if 'wakeup' in permission or 'wake up' in permission or 'hello' in self.query or 'time to work' in permission or 'hey' in permission:
                         speak('welcome back')
                         self.TaskExecution()
...
class Main(QMainWindow):
     ...
     def startTask(self):
          self.ui.movie = QtGui.QMovie("picsgifs/mid2.gif")
          self.ui.label_2.setMovie(self.ui.movie)
          self.ui.movie.start()
          self.ui.movie = QtGui.QMovie("picsgifs/robo4.gif")
